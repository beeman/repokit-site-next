...
export function TemplatesUiLayoutList({ templates }: { templates: RepokitTemplate[] }) {
  const { clear, filteredListings } = useTemplateFilterState({ templates })

  return (
    <div className="grid md:grid-cols-4 gap-4 lg:gap-8">
      <div className="md:col-span-1">
        <div className="hidden md:block">
          <TemplatesUiFilter templates={templates} />
        </div>
      ...
      <div className="md:col-span-3">
        {filteredListings.length ? (
          <TemplatesUiGrid templates={filteredListings} />
        ) : (
